...
@section('content')
    ...
    <form class="form-horizontal" role="form" method="POST" action="{{URL::to('admin/modifdone')}}">
        {{csrf_field()}}
        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-md-4">
                    <input id="name" name="oldname" type="hidden" placeholder="Nom de l'association" class="form-control input-md" value="{{$new->name}}" required>
                </div>
            </div>
            <!-- Text input-->
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="name" name="name" type="text" placeholder="Nom de l'association" class="form-control input-md" value="{{$new->name}}" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="type" name="type" type="text" placeholder="Catégorie de l'association" value="{{$new->type}}" class="form-control input-md">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea class="form-control" id="description" name="description">value="{{$new->description}}"</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="url" name="url" type="text" placeholder="URL de l'association" value="{{$new->url}}" class="form-control input-md">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="image" name="image" type="text" placeholder="Image de l'association" value="{{$new->image}}" class="form-control input-md">
                </div>
            </div>
